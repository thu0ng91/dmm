...
var RLANG = {
    ...
    _delete: '删除',
    insert_table: '插入表格',
    insert_row_above: '在上方增加行',
    insert_row_below: '在下方增加行',
    insert_column_left: '在左侧增加列',
    insert_column_right: '在右侧增加列',
    delete_column: '删除列',
    delete_row: '删除行',
    delete_table: '删除表格',
    rows: '行',
    ...
    mailto: 'Email',
    web: 'URL',
    video_html_code: '视频嵌入码',
    file: '文件',
    upload: '上传',
    download: '下载',
    choose: '选择',
    or_choose: '或者选择',
    drop_file_here: '拖拽到这里',
    align_left: '左对齐',
    align_center: '居中',
    align_right: '右对齐',
    align_justify: '两端对齐',
